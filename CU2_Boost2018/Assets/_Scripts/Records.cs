...
public class Records : MonoBehaviour {
   ...
   private const int RECORD_LIMIT = 27;
   ...
   public void Add(float record)
   {
      ...
      if (record <= 1)
      {
         records.Add(comOne[OneOf(comOne)] + stringRecord + "\n");
      }
      else if (record > 1 && record <= 3)
      {
         records.Add(comTwo[OneOf(comTwo)] + stringRecord + "\n");
      }
      else if (record > 3 && record <= 4)
      {
         records.Add(comThree[OneOf(comThree)] + stringRecord + "\n");
      }
      else if (record > 4 && record <= 5)
      {
         records.Add(comFour[OneOf(comFour)] + stringRecord + "\n");
      }
      else if (record > 5 && record <= 6)
      {
         records.Add(comFive[OneOf(comFive)] + stringRecord + "\n");
      }
      else if (record > 6 && record <= 8)
      {
         records.Add(comSix[OneOf(comSix)] + stringRecord + "\n");
      }
      else if (record > 8 && record <= 10)
      {
         records.Add(comSeven[OneOf(comSeven)] + stringRecord + "\n");
      }
      else if (record > 10)
      {
         records.Add(comEight[OneOf(comEight)] + stringRecord + "\n");
      }
   }
